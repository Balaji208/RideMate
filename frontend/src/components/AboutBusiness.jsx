        ...
        >
          <motion.div variants={headerVariants}>
            <h3 className="inter-font text-4xl font-bold max-md:text-2xl max-md:text-center">
              The RideMate you know, reimagined for business
            </h3>
          </motion.div>
          <motion.div
          ...
          >
            <h1 className="inter-font text-lg max-md:text-base">
              RideMate for Business is a platform for managing global rides and meals, and local deliveries, for companies of any size.
            </h1>
          </motion.div>
          <motion.div
