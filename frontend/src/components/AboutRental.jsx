...
import AboutFleet from '/fleet-management.webp';
...
const AboutRental = () => {
  ...
  return (
    <>
      <motion.div
        className="w-full flex flex-row mx-4 mt-20 space-x-20 max-md:flex-col max-md:space-x-0 max-md:space-y-8"
        ...
        >
          ...
          >
            <h1 className="inter-font text-lg max-md:text-base">
              Connect with thousands of drivers and earn more per week with RideMate’s free fleet management tools.
            </h1>
          </motion.div>
          <motion.div
          ...
          >
            ...
            {/* Uncomment and add animation if needed */}
            {/* <motion.h1
