...
import Ride from "/Airport-Fall.webp";
...
const AboutRider = () => {
  ...
  return (
    <>
      <motion.div
        className="w-full flex flex-row mx-4 mt-32 space-x-20 max-md:flex-col max-md:space-x-0 max-md:space-y-8"
      ...
      >
        ...
        >
          ...
          <motion.div
            className="flex flex-col justify-center mt-8 space-y-4 max-md:mt-6 max-md:flex-col max-md:space-x-0 max-md:space-y-4 max-md:items-center"
            variants={containerVariants}
          >
            <motion.button
              className="inter-font h-12 bg-black w-48 rounded cursor-pointer"
              variants={buttonVariants}
              whileHover="hover"
            >
              <p className="text-white font-medium">Login To your account</p>
            </motion.button>
            <motion.h1
